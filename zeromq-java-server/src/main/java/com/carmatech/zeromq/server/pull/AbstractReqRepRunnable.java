 ...
 */
abstract class AbstractReqRepRunnable implements Runnable {
	private static final Logger LOGGER = LoggerFactory.getLogger(AbstractReqRepRunnable.class);

	protected final Socket socket;
	protected final IProtocol protocol;
	protected final Function<UUID, byte[]> provider;

	AbstractReqRepRunnable(final Socket socket, final IProtocol protocol, final Function<UUID, byte[]> provider) {
